...
const PageNotFound: FunctionComponent<PageNotFoundProps> = ({}) => {
    ...
    return (
        <div className="h-full w-full overflow-clip bg-gray-light-1 font-inter dark:bg-gray-dark-1">
            <Head>
                {/* <!-- HTML Meta Tags --> */}
                <title>Hiroes - Heroes for Hire</title>
                <meta name="description" content="Get a hero tp safe your day!" />
            </Head>
            <Favicon />
            <Navigation />
            ...
            <div className="mt-16 sm:absolute sm:inset-x-0 sm:bottom-0"></div>
        </div>
    );
};
